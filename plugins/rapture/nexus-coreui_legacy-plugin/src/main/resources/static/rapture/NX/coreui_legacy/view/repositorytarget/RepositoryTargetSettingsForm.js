 ...
 * @since 3.0
 */
Ext.define('NX.coreui_legacy.view.repositorytarget.RepositoryTargetSettingsForm', {
  extend: 'NX.view.SettingsForm',
  alias: 'widget.nx-coreui_legacy-repositorytarget-settings-form',
  requires: [
    'NX.Conditions',
    'NX.I18n'
  ],
  ...
  api: {
    submit: 'NX.direct.coreui_legacy_RepositoryTarget.update'
  },
