...
Ext.define('NX.coreui_legacy.controller.HealthCheckRepositoryColumn', {
  ...
  /**
   * @private
   * Update Health Check column tooltip based on {NX.coreui_legacy.model.HealthCheckRepositoryStatus}.
   ...
   * @param NX.coreui_legacy.model.HealthCheckRepositoryStatus status Health Check status model
