    ...
    me.items = [
      {
        ...
        fieldLabel: NX.I18n.get('LEGACY_ADMIN_AUTHENTICATION_USERNAME'),
        allowBlank: false
      },
      {
        xtype: 'nx-password',
        name: namePrefix + 'uthPassword',
        fieldLabel: NX.I18n.get('LEGACY_ADMIN_AUTHENTICATION_PASSWORD')
      },
      {
        name: namePrefix + 'uthNtlmHost',
        fieldLabel: NX.I18n.get('LEGACY_ADMIN_AUTHENTICATION_HOST')
      },
      {
        name: namePrefix + 'uthNtlmDomain',
        fieldLabel: NX.I18n.get('LEGACY_ADMIN_AUTHENTICATION_DOMAIN')
      }
    ];
