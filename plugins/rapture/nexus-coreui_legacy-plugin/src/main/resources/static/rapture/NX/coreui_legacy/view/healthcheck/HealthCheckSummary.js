 ...
 * @since 3.0
 */
Ext.define('NX.coreui_legacy.view.healthcheck.HealthCheckSummary', {
  extend: 'Ext.window.Window',
  alias: 'widget.nx-coreui_legacy-healthcheck-summary',
  requires: [
    'Ext.util.DelayedTask'
  ],

  /**
   * @cfg {NX.coreui_legacy.model.HealthCheckRepositoryStatus} model corresponding to this summary report
   */
