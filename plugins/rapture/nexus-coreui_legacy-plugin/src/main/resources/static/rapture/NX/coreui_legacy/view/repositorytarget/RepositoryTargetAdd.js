 ...
 * @since 3.0
 */
Ext.define('NX.coreui_legacy.view.repositorytarget.RepositoryTargetAdd', {
  extend: 'NX.view.AddWindow',
  alias: 'widget.nx-coreui_legacy-repositorytarget-add',
  requires: [
    'NX.Conditions',
    'NX.I18n'
  ],
  ...
  initComponent: function() {
    ...
    me.items = {
      xtype: 'nx-coreui_legacy-repositorytarget-settings-form',
      api: {
