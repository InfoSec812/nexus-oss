...
Ext.define('NX.coreui_legacy.app.PluginStrings', {
  ...
  keys: {
    ...
    LEGACY_ADMIN_REPOSITORIES_SELECT_CANCEL_BUTTON: 'Cancel',
    ...
    LEGACY_ADMIN_REPOSITORIES_DETAILS_REBUILD_SUCCESS: 'Started rebuilding metadata of ""',
    ...
    LEGACY_ADMIN_ROUTING_TITLE: 'Routing (legacy)',
    LEGACY_ADMIN_ROUTING_SUBTITLE: 'Manage repository routes',
    LEGACY_ADMIN_ROUTING_UPDATE_ERROR: 'You do not have permission to update routes',
    LEGACY_ADMIN_ROUTING_UPDATE_SUCCESS: 'Repository route updated: ',
    LEGACY_ADMIN_ROUTING_CREATE_TITLE: 'Create Route',
    LEGACY_ADMIN_ROUTING_CREATE_ERROR: 'You do not have permission to create routes',
    LEGACY_ADMIN_ROUTING_CREATE_SUCCESS: 'Repository route created: ',
    LEGACY_ADMIN_ROUTING_LIST_NEW_BUTTON: 'Create route',
    LEGACY_ADMIN_ROUTING_LIST_ROUTE_COLUMN: 'Route',
    LEGACY_ADMIN_ROUTING_LIST_RULE_COLUMN: 'Rule type',
    LEGACY_ADMIN_ROUTING_LIST_GROUP_COLUMN: 'Group',
    LEGACY_ADMIN_ROUTING_LIST_REPOSITORIES_COLUMN: 'Repositories',
    LEGACY_ADMIN_ROUTING_LIST_EMPTY_STATE: 'No repository routes defined',
    LEGACY_ADMIN_ROUTING_LIST_FILTER_ERROR: 'No repository routes matched "$filter"',
    LEGACY_ADMIN_ROUTING_DETAILS_DELETE_BUTTON: 'Delete route',
    LEGACY_ADMIN_ROUTING_DELETE_SUCCESS: 'Route deleted: {0}',
    LEGACY_ADMIN_ROUTING_DETAILS_SETTINGS_TAB: 'Settings',
    LEGACY_ADMIN_ROUTING_SETTINGS_URL: 'URL pattern',
    LEGACY_ADMIN_ROUTING_SETTINGS_URL_HELP: 'A regular expression used to match the artifact path. The path is everything after /nexus/content/.',
    LEGACY_ADMIN_ROUTING_SETTINGS_URL_PLACEHOLDER: '.*/com/some/company/.*',
    LEGACY_ADMIN_ROUTING_SETTINGS_RULE: 'Rule type',
    LEGACY_ADMIN_ROUTING_SETTINGS_RULE_PLACEHOLDER: 'Select a type',
    LEGACY_ADMIN_ROUTING_SETTINGS_BLOCKING_ITEM: 'Blocking (block URLs matching the pattern)',
    LEGACY_ADMIN_ROUTING_SETTINGS_INCLUSIVE_ITEM: 'Inclusive (if the pattern matches, only use the repositories listed below)',
    LEGACY_ADMIN_ROUTING_SETTINGS_EXCLUSIVE_ITEM: 'Exclusive (exclude the repositories listed below)',
    LEGACY_ADMIN_ROUTING_SETTINGS_GROUP: 'Repository group',
    LEGACY_ADMIN_ROUTING_SETTINGS_GROUP_PLACEHOLDER: 'Select a group',
    LEGACY_ADMIN_ROUTING_SETTINGS_GROUP_ALL_ITEM: 'All repository groups',
    LEGACY_ADMIN_ROUTING_SETTINGS_REPOSITORIES: 'Repositories to search',
    LEGACY_ADMIN_ROUTING_SETTINGS_REPOSITORIES_HELP: 'Ordered list of repositories which will be searched to locate a particular artifact',
    LEGACY_ADMIN_ROUTING_SETTINGS_AVAILABLE: 'Available',
    LEGACY_ADMIN_ROUTING_SETTINGS_ORDERED: 'Ordered',

    // Admin -> Repository -> Targets
    LEGACY_ADMIN_TARGETS_TITLE: 'Targets (legacy)',
    LEGACY_ADMIN_TARGETS_SUBTITLE: 'Manage repository targets',
    LEGACY_ADMIN_TARGETS_UPDATE_ERROR: 'You do not have permission to update targets',
    LEGACY_ADMIN_TARGETS_UPDATE_SUCCESS: 'Repository target updated: ',
    LEGACY_ADMIN_TARGETS_CREATE_TITLE: 'Create Target',
    LEGACY_ADMIN_TARGETS_CREATE_ERROR: 'You do not have permission to create targets',
    LEGACY_ADMIN_TARGETS_CREATE_SUCCESS: 'Repository target created: ',
    LEGACY_ADMIN_TARGETS_LIST_NEW_BUTTON: 'Create target',
    LEGACY_ADMIN_TARGETS_LIST_NAME_COLUMN: 'Name',
    LEGACY_ADMIN_TARGETS_LIST_REPOSITORY_COLUMN: 'Repository type',
    LEGACY_ADMIN_TARGETS_LIST_PATTERNS_COLUMN: 'Patterns',
    LEGACY_ADMIN_TARGETS_LIST_EMPTY_STATE: 'No repository targets defined',
    LEGACY_ADMIN_TARGETS_LIST_FILTER_ERROR: 'No repository targets matched "$filter"',
    LEGACY_ADMIN_TARGETS_DETAILS_DELETE_BUTTON: 'Delete target',
    LEGACY_ADMIN_TARGETS_DETAILS_DELETE_SUCCESS: 'Target deleted: {0}',
    LEGACY_ADMIN_TARGETS_DETAILS_SETTINGS_TAB: 'Settings',
    LEGACY_ADMIN_TARGETS_SETTINGS_NAME: 'Target name',
    LEGACY_ADMIN_TARGETS_SETTINGS_TYPE: 'Content class',
    LEGACY_ADMIN_TARGETS_SETTINGS_TYPE_HELP: 'This target will only be matched against repositories with the same content class',
    LEGACY_ADMIN_TARGETS_SETTINGS_TYPE_PLACEHOLDER: 'Select a content class',
    LEGACY_ADMIN_TARGETS_SETTINGS_PATTERNS: 'Patterns',
    LEGACY_ADMIN_TARGETS_SETTINGS_PATTERNS_HELP: 'Regular expressions are used to match the artifact path',
    LEGACY_ADMIN_TARGETS_SETTINGS_PATTERNS_PLACEHOLDER: '^/com/some/company/.*'
  }
}, function(obj) {
